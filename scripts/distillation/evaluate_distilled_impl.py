...
def clip_feature_tensor(output: Any) -> torch.Tensor:
    """Unwrap projected CLIP features across Transformers API versions."""
...
def apply_latency_measurement_tolerance(
    result: dict[str, Any],
) -> dict[str, Any]:
...
def evaluate(args: argparse.Namespace) -> dict[str, Any]:
    ...
    result = apply_latency_measurement_tolerance(result)
